...
assignment : 
    ...
    |
      ...
      {
        itab_instruction_add (itab, OP_JZ, $4->addr, NOARG, TBDARG);
        itab_instruction_add (itab, OP_STORE, $2->addr, $2->datatype, $6->addr);
        itab->tab[INSTRUCTION_LAST - 1]->addr3 = INSTRUCTION_NEXT;
        $$ = $2;
      }
    |
      T_PRED_ASSIGN_SC varref T_ASSIGN l_expr 
      {
        ...
        T_PRED_SEP a_expr 
      {
        itab_instruction_add (itab, OP_STORE, $2->addr, $2->datatype, $7->addr);
        int jmp_entry = @5.begin.line;
        itab->tab[jmp_entry]->addr3 = INSTRUCTION_NEXT;
        $$ = $2;
      }
