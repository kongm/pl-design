...
#line 697 "simple.cc" // lalr1.cc:859
    break;

  case 15:
#line 155 "grammar.y" // lalr1.cc:859
    {
...
#line 708 "simple.cc" // lalr1.cc:859
    break;

  case 16:
#line 164 "grammar.y" // lalr1.cc:859
    {
        // TASK: Abort if the datatype of a_expr and a_term differ.
        // TASK: Complete support for OP_SUB and OP_FSUB. See OP_ADD and OP_FADD code above.
        symbol_t * res;
...
#line 731 "simple.cc" // lalr1.cc:859
    break;

  case 17:
#line 183 "grammar.y" // lalr1.cc:859
    {
        // TASK: Abort if the datatype of a_expr and a_term differ.
        // TASK: Complete support for OP_SUB and OP_FSUB. See OP_ADD and OP_FADD code above.
        symbol_t * res;
...
#line 755 "simple.cc" // lalr1.cc:859
  ...
  case 18:
#line 203 "grammar.y" // lalr1.cc:859
    {
        yylhs.value.as< symbol_t* > () = yystack_[0].value.as< symbol_t* > ();
        #ifdef _SMP_DEBUG_
        cout << "On a_term (3)\n";
...
#line 766 "simple.cc" // lalr1.cc:859
    break;
...
#line 778 "simple.cc" // lalr1.cc:859
    break;
...
#line 791 "simple.cc" // lalr1.cc:859
    break;
...
#line 805 "simple.cc" // lalr1.cc:859
    break;

  case 22:
#line 238 "grammar.y" // lalr1.cc:859
    { yylhs.value.as< symbol_t* > () = yystack_[1].value.as< symbol_t* > (); }
#line 811 "simple.cc" // lalr1.cc:859
    break;

  case 23:
#line 240 "grammar.y" // lalr1.cc:859
    {
        symbol_t * res;
        res = make_temp (symtab, yystack_[0].value.as< symbol_t* > ()->datatype);
...
#line 822 "simple.cc" // lalr1.cc:859
    break;
...
#line 830 "simple.cc" // lalr1.cc:859
  ...
  case 25:
#line 253 "grammar.y" // lalr1.cc:859
    {
...
#line 840 "simple.cc" // lalr1.cc:859
    break;
...
#line 857 "simple.cc" // lalr1.cc:859
    break;

  case 27:
#line 276 "grammar.y" // lalr1.cc:859
    {
      vector_itersym_t iter;
      int ii = 0;
      for (iter = yystack_[0].value.as< vector<symbol_t*>  > ().begin (); iter != yystack_[0].value.as< vector<symbol_t*>  > ().end (); iter++, ii++)
...
#line 874 "simple.cc" // lalr1.cc:859
    break;
...
#line 880 "simple.cc" // lalr1.cc:859
    break;

  case 29:
#line 291 "grammar.y" // lalr1.cc:859
    { yylhs.value.as< vector<symbol_t*>  > ().push_back (yystack_[0].value.as< symbol_t* > ()); }
#line 886 "simple.cc" // lalr1.cc:859
    break;
...
#line 897 "simple.cc" // lalr1.cc:859
    break;

  case 31:
#line 302 "grammar.y" // lalr1.cc:859
    { 
      yylhs.value.as< vector<symbol_t*>  > ().push_back (yystack_[0].value.as< symbol_t* > ()); 
      #ifdef _SMP_DEBUG_
      cout << "In expr_list (2)\n";
...
#line 908 "simple.cc" // lalr1.cc:859
    break;
...
#undef YYCASE_
  ...
  simple_parser::yyrline_[] =
  {
      ...
      93,   102,   103,   106,   132,   154,   163,   182,   202,   211,
     219,   228,   238,   239,   246,   252,   260,   275,   290,   291,
     294,   301
  };
...
#line 1308 "simple.cc" // lalr1.cc:1167
#line 310 "grammar.y" // lalr1.cc:1168
